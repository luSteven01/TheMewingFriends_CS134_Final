...
public:
	...
	vector<ofColor> colors = { ofColor::red, ofColor::coral, ofColor::pink, ofColor::salmon, ofColor::deepPink,
		ofColor::orange, ofColor::yellow, ofColor::green, ofColor::blue, ofColor::darkCyan,
		ofColor::aqua, ofColor::aquamarine, ofColor::azure, ofColor::darkBlue, ofColor::deepSkyBlue,
		ofColor::indigo, ofColor::violet, ofColor::fuchsia, ofColor::lavender, ofColor::darkViolet };
